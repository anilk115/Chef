...
#
# This recipe will create four instances of each tomcatA and tomcatB
...
%w[ /opt/middleware/tomcatA/tomcatA1
    ...
    /opt/middleware/tomcatA/tomcatA3
    /opt/middleware/tomcatA/tomcatA3/bin
    /opt/middleware/tomcatA/tomcatA3/conf
    /opt/middleware/tomcatA/tomcatA3/webapps
    /opt/middleware/tomcatA/tomcatA3/temp
    /opt/middleware/tomcatA/tomcatA3/work
    /opt/middleware/tomcatA/tomcatA3/lib
    /opt/middleware/tomcatA/tomcatA4
    /opt/middleware/tomcatA/tomcatA4/bin
    /opt/middleware/tomcatA/tomcatA4/conf
    /opt/middleware/tomcatA/tomcatA4/webapps
    /opt/middleware/tomcatA/tomcatA4/temp
    /opt/middleware/tomcatA/tomcatA4/work
    /opt/middleware/tomcatA/tomcatA4/lib
    ...
    /opt/middleware/tomcatB/tomcatB3
    /opt/middleware/tomcatB/tomcatB3/bin
    /opt/middleware/tomcatB/tomcatB3/conf
    /opt/middleware/tomcatB/tomcatB3/webapps
    /opt/middleware/tomcatB/tomcatB3/temp
    /opt/middleware/tomcatB/tomcatB3/work
    /opt/middleware/tomcatB/tomcatB3/lib
    /opt/middleware/tomcatB/tomcatB4
    /opt/middleware/tomcatB/tomcatB4/bin
    /opt/middleware/tomcatB/tomcatB4/conf
    /opt/middleware/tomcatB/tomcatB4/webapps
    /opt/middleware/tomcatB/tomcatB4/temp
    /opt/middleware/tomcatB/tomcatB4/work
    /opt/middleware/tomcatB/tomcatB4/lib
    /var/log/tomcatA/tomcatA1
    /var/log/tomcatA/tomcatA2
    /var/log/tomcatA/tomcatA3
    /var/log/tomcatA/tomcatA4
    /var/log/tomcatB/tomcatB1
    /var/log/tomcatB/tomcatB2
    /var/log/tomcatB/tomcatB3
    /var/log/tomcatB/tomcatB4
    ].each do |path|
      directory path do
      owner tcuser
      group tcgroup
...
template "/home/tomcat/.bash_profile" do
  source "large_bash_profile.sh.erb"
  owner "#{tcuser}"
  group "#{tcgroup}"
  mode "0744"
end
...
for instance in [ "A1", "A2", "A3", "A4" ] do
...
for instance in [ "B1", "B2", "B3", "B4" ] do
  ...
  template '/etc/logrotate.d/tomcat' do
    source 'logrotate_tomcat_large.conf.erb'
    owner 'root'
    group 'root'
    mode '0644'
  end
...
node.set['middleware'][:size] = 'large'
